...
Lower-semicontinuity of $\mathcal{E}$ actually follows fairly readily, giving us a minimizer. Given $\varphi_n\rightharpoonup \varphi$, we actually have [@coti_zelati_ground_2019] $(\varphi_n,V\varphi_n)\rightarrow 0$, so combining this, Kato's inequality, and weak lower-semicontinuity of the norm yields weak lower-semicontinuity of $\mathcal{E}$. 
